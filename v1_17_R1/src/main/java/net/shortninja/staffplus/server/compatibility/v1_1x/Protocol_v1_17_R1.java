...
public class Protocol_v1_17_R1 extends AbstractProtocol implements IProtocol {
   ...
   /* @Override
    ...
    public void inject(Player player) {
        ...
        pipeline.addBefore("packet_handler", player.getUniqueId().toString(), new PacketHandler_v1_17_R1(player));
    }
